...
const initialItinerary = [
  { 
    ...
    activities: [
      { id: 'a_v1', time: '01:00', name: 'Salida MDE → MEX', notes: '✈️ Llegada 04:35 AM. 🇲🇽 LOGÍSTICA: Es obligatorio hacer pre-registro y migración en México si se desea salir. Recomendación: Desayunar tacos en el Centro Histórico.', link: 'https://www.inm.gob.mx/spublic/portal/inmex.html', linkLabel: '📝 Pre-registro MX' },
      { id: 'a_v2', time: '22:15', name: 'MEX → NRT', notes: '✈️ Tramo largo hacia Tokio. Estar de vuelta en el aeropuerto 3 horas antes.' }
    ] 
  },
  { 
    id: 'd1', date: '15-may', region: 'TOKIO', theme: 'blue', mainActivity: 'Asakusa + Skytree + Compras', 
    routeQuery: 'saddr=Narita+International+Airport&daddr=Senso-ji+to:Tokyo+Skytree+to:Don+Quijote+Asakusa',
    activities: [
      { id: 'a1', time: '06:30', name: 'Aterrizaje Narita (NRT)', notes: 'Pasar migración. Recoger Suica/Pasmo. 🚆 TRASLADO: Tomar Tren Keisei Skyliner (Aeropuerto ↔ Tokio) hasta Ueno.', link: 'https://www.vjw.digital.go.jp/', linkLabel: '🛂 Visit Japan Web' },
      { id: 'a3', time: '13:00', name: 'Templo Senso-ji', notes: '⛩️ Recorrer Nakamise. 🛍️ Comprar el "Goshuincho" (Libro de sellos). Ver el Centro Turístico Asakusa (Mirador gratis).' },
      { id: 'a4', time: '17:30', name: 'Tokyo Skytree', hours: '10:00 - 21:00', notes: '🎟️ Subir para ver el atardecer. Cruzar el río viendo el edificio Asahi.' },
      { id: 'a5', time: '19:30', name: 'Don Quijote + Hobby Off', notes: '🛍️ Compras de snacks y figuras de anime baratas en Asakusa.' }
    ] 
  },
  { 
    ...
    activities: [
      ...
      { id: 'a6', time: '14:00', name: 'Odaiba (Gundam Base)', notes: '🚆 Tren Yurikamome. Ver el Gundam gigante y centro DiverCity.' },
      { id: 'a7', time: '18:30', name: 'Shinkansen a Osaka', notes: '🚆 Salida Estación Tokio. Cenar Eki-ben en el tren bala.' }
    ] 
  },
  { 
    id: 'd3', date: '17-may', region: 'NAGOYA / OSAKA - PARQUE GHIBLI', theme: 'rose', mainActivity: 'Ghibli Park + Dotonbori', 
    routeQuery: 'saddr=Shin-Osaka+Station&daddr=Ghibli+Park,+Aichi+to:Dotonbori,+Osaka',
    activities: [
      { id: 'a11', time: '10:00', name: 'Parque Ghibli (Nagoya)', hours: '10:00 - 17:00', notes: '🎟️ CONFIRMADO. 🛍️ Souvenirs exclusivos en Adventurous Spirit.', link: 'https://quickticket.moala.fun/books?id=14afc57f-d0b6-4a66-a902-7bb79d1e4e7f', linkLabel: '🎟️ Entrada' },
      { id: 'a11b', time: '17:30', name: 'Regreso a Osaka', notes: '🚆 LOGÍSTICA REGRESO: Tren Linimo -> Metro Higashiyama -> Shinkansen de Nagoya a Shin-Osaka.' },
      { id: 'a12', time: '19:30', name: 'Dotonbori (Osaka)', notes: '🐙 Noche de comida. Takoyaki y cartel de Glico Man.' }
    ] 
  },
  { 
  ...
  { 
    ...
    activities: [
      { id: 'a14', time: '09:30', name: 'Templo Todai-ji + Kasuga Taisha', notes: '🦌 Ciervos y Buda gigante. 🚆 TRASLADO: Tren Kintetsu desde Namba. 🚆 REGRESO: Tren Kintetsu vuelta a Osaka.' },
      { id: 'a14b', time: '15:00', name: 'Naramachi', notes: '🚶 Distrito antiguo comercial.' }
    ] 
  },
  { 
    ...
    activities: [
      ...
      { id: 'a27', time: '11:00', name: 'Shibazakura Festival', notes: '🌸 Fuji con flores rosas. 🚌 TRASLADO: Bus local desde Mishima.' },
      { id: 'a28', time: '16:00', name: 'Bus de Larga Distancia (Highway Bus)', notes: '🚌 Regreso directo del Fuji a Shinjuku (Tokio). 🎟️ RESERVA PREVIA.' },
      { id: 'a28b', time: '19:30', name: 'Omoide Yokocho (Shinjuku)', notes: '🍢 Cena en el famoso callejón retro.' }
    ] 
  },
  { 
    ...
    activities: [
      { id: 'a31', time: '10:00', name: 'Barrio Shimokitazawa', notes: '🛍️ Ropa vintage, cafés y discos. 🚆 TRASLADO: A solo 5 min de Shibuya en línea Keio Inokashira.' },
      { id: 'a31b', time: '13:00', name: 'Nintendo Tokyo (Shibuya PARCO)', notes: '🕹️ Tienda oficial (Piso 6 de PARCO). Compras finales de regalos.' },
      { id: 'a32', time: '20:00', name: 'Despedida Mauro y Julián', notes: '✈️ Ellos salen al aeropuerto. El resto se muda al Hotel Tokio 3 (Ueno).' }
    ] 
  }
];
      ...
      <div className={`sticky top-0 z-20 ${isDarkMode ? 'bg-slate-950 border-slate-800' : 'bg-white border-slate-100'} border-b pt-safe`}>
        ...
        <div className="flex px-3 pb-2 justify-between max-w-md mx-auto">
          {[ { id: 'resumen', icon: Home, label: 'Info' }, { id: 'itinerario', icon: Map, label: 'Ruta' }, { id: 'mapa', icon: MapPin, label: 'Mapa' }, { id: 'reservas', icon: CheckSquare, label: 'Check' } ].map((item) => (
            <button key={item.id} onClick={() => setActiveTab(item.id)} className={`flex flex-col items-center justify-center gap-1.5 py-3 w-20 rounded-[20px] transition-all ${activeTab === item.id ? (isDarkMode ? 'bg-white text-slate-900 shadow-lg' : 'bg-slate-900 text-white shadow-lg') : 'text-slate-400'}`}>
          ...
          <div className="space-y-4 animate-in fade-in">
            <div className={`rounded-[28px] p-6 border ${isDarkMode ? 'bg-emerald-900/20 border-emerald-900/30' : 'bg-emerald-50 border-emerald-100'}`}>
               ...
               <ul className="text-xs space-y-3 font-medium">
                 ...
                 <li>• <strong>Okashi No Machioka:</strong> Dulces baratos.</li>
                 <li>• <strong>Matsumoto Kiyoshi:</strong> Skincare viral.</li>
                 <li>• <strong>Lawson Store 100 / Daiso:</strong> Todo a 100 yenes.</li>
               </ul>
            </div>

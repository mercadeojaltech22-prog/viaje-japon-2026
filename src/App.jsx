...
const initialItinerary = [
  ...
  { 
    ...
    activities: [
      { id: 'a33', time: '10:00', name: 'Sanrio World Ginza', notes: '🛍️ La tienda más grande de Sanrio.' },
      { id: 'a34', time: '14:00', name: 'teamLab Planets (OPCIONAL)', notes: '🎟️ Reserva previa. Aprovechar la cercanía de Ginza con Toyosu.' }
    ] 
  },
  { 
  ...
  { 
    id: 'd14', date: '28-may', region: 'TOKIO → SEÚL', theme: 'blue', mainActivity: 'Tokio → Seúl', 
    routeQuery: 'saddr=Ueno+Station&daddr=Narita+International+Airport+to:Incheon+International+Airport',
    activities: [
  ...
  { 
    ...
    activities: [
      { id: 'a40', time: '11:40', name: 'Vuelo ICN → MEX', notes: '✈️ ⏱️ Escala en CDMX. Mejor descansar en sala VIP.' },
      { id: 'a41', time: '22:00', name: 'Aterrizaje en Medellín (MDE)', notes: '✈️ Fin de la aventura. 🎌' }
    ] 
  }
];
